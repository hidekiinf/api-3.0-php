...
```
composer require "hidekiinf/api-3.0-php"
```
...
Para mais informações sobre a integração com a API 3.0 da Cielo, vide o manual em: [Integração API 3.0](https://hidekiinf.github.io/manual/cielo-ecommerce)
"# api-3.0-php" 
